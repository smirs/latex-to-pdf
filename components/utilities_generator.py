...
MAIN_TEX_FILE = "addundum_utilities.tex"

def generate_utilities_pdf(form_data):
    ...
    tex_filename = "output_utilities.tex"
    tex_path = os.path.join(TEX_DIR, tex_filename)
    with open(tex_path, "w") as f:
        f.write(latex_content)

    os.makedirs(OUTPUT_FOLDER, exist_ok=True)
    pdf_path = os.path.join(OUTPUT_FOLDER, "output_utilities.pdf")
